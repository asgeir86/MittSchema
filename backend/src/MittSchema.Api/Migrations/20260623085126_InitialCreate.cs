...
namespace MittSchema.Api.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandlaggareId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientProfiles_HandlaggareId",
                table: "ClientProfiles",
                column: "HandlaggareId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_ClientUserId_Status",
                table: "Requests",
                columns: new[] { "ClientUserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_ClientUserId",
                table: "Schedules",
                column: "ClientUserId",
                unique: true);
        }
